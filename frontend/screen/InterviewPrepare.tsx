...
interface InterviewPrepareProps {
  colors: ThemeColors;
...
export const InterviewPrepare: React.FC<InterviewPrepareProps> = ({ colors, s, onFinish }) => {
      ...
      <div style={{ ...s.whiteSheet, margin: 0, flex: 1, padding: '40px', display: 'flex', flexDirection: 'column' }}>
        <div style={styles.taskCard}>
          <div style={styles.taskContent}>
            ...
            <p style={styles.taskText}>Task 3. Interviewer</p>
          </div>
          ...
          <div style={styles.controlsRow}>
            <div style={styles.progressBarWrapper}>
              ...
              <div style={styles.barBackground}>
                <div style={{ ...styles.barFill, width: '0%' }} />
              </div>
            ...
            <button
              disabled={true} // Кнопка всегда заблокирована
              style={{ 
                ...styles.finishBtn, 
